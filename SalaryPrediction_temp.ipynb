...
error = np.sqrt(metrics.mean_squared_error(Y_test,y_pred_linear))
print(error)
...
error_dtree = np.sqrt(metrics.mean_squared_error(Y_test,y_pred_dtree))
